...
public class ModelAlignmentObservanceCheckDAO extends CommonDAO{

	public ModelAlignmentObservanceCheckDAO() throws Exception
	{
		super();
	}
	public ModelAlignmentObservanceCheckDAO(DBAssistant dba) throws Exception
	{
		super(dba);
	}
