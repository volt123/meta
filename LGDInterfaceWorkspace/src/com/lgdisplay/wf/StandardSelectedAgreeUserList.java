...
//협의자  정보
public class StandardSelectedAgreeUserList implements IFieldListValue ,com.itplus.wf.inst.app.IApplication
{
	/**
	 * WORKS_BOX_ID,   
...
//		CacheResultSet rs = null;		
		CacheResultSet reqSelectedAgreeUserRs = null;
...
//		}
		...
		p.put("INST_ID", param.getParameter("INST_ID"));

		if (debugMode) {
			System.out.println ("############# Debuging - Start ###############");
			System.out.println ("INST_ID : " + (String)param.getParameter("INST_ID"));
			System.out.println ("################ Debuging - End ###############");
		}

		reqSelectedAgreeUserRs = lgdDao.findSelectedAgreeUsersByInstId(p);
